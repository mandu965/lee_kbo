...
export default function SchedulePage() {
  ...
  const { data, isLoading } = useSWR(`${BASE}/games?date=${date}`, fetcher);
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <span className="text-slate-400 text-sm">{fmtDate(date)}</span>
      </div>

      {isLoading ? (
        <div className="text-slate-500 text-center py-16">로딩 중...</div>
      ) : games.length === 0 ? (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex flex-col items-center flex-1">
                    ...
                    <span className="text-slate-500 text-xs">{g.away_team?.name}</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center flex-1">
                    ...
                    <span className="text-slate-500 text-xs">{g.home_team?.name}</span>
                  </div>
